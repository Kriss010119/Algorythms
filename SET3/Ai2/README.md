...
ID посылки: 349266225

  

Ссылка на ID: https://dsahse25.contest.codeforces.com/group/SLdI1pWUpC/contest/647790/submission/349266225

  

Гитхаб: https://github.com/Kriss010119/Algorythms/tree/main/SET3/A2i
...
Ниже приведены графики анализа:

![alt text](analize.png)

Можно заметить, что гибрид покруче обычной сортировки, так как работает быстрее. Плюс, с увеличением числа элементов растет время работы алгоритма

Быстрее всего гибрид работает на почти упорядоченных массивах ~ в 3-4 раза ускорение. На случайных и обратных данных ускоряется в 1.5-2 раза

Лучше всего переключаться на Insertion Sort, когда осталось 20-30 элементов, это поможет ускориться

Размер массива особо не влияет на порог, при котором становится выгоднее начать сортировать его простым методом а тип данных влияет сильно
