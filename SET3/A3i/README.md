...
ID посылки: 349339160

  

Ссылка на ID: https://dsahse25.contest.codeforces.com/group/SLdI1pWUpC/contest/647790/submission/349339160

  

Гитхаб: https://github.com/Kriss010119/Algorythms/tree/main/SET3/A3i
...
![alt text](hibrid_random.png)
![alt text](hibrid_reverse.png)
![alt text](hibrid_almost_sorted.png)
![alt text](quick.png)
![alt text](hibridVSquick.png)


Видно, что hibrid работает быстрее обычного quickSort

Сильнее всего гибрид ускорился на почти готовых массивах

Чем больше чисел в массиве, тем дольше работают обе сортировки

QuickSort работает медленнее всего на рандомных данных
